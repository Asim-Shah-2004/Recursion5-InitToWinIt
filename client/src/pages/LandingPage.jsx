...
=======
                    <div className='z-10 p-8  relative -left-64 bg-black w-[500px]'>
                        ...
                        {/* <button className="ml-10 relative overflow-hidden bg-[#000000] text-[#FFB0B0] p-4 rounded-xl font-bold text-2xl hover:bg-[#FC6736] hover:text-[#0C2D57] transition duration-300 ease-in-out">
                            <span className="absolute top-0 left-0 w-full h-full bg-[#FC6736] mix-blend-multiply transition-transform duration-300 ease-in-out transform scale-0 origin-top-left"></span>
                            Register
                        </button> */}
                        {/* <button className='bg-[#FC6736] text-[#0C2D57] p-4 rounded-xl'>Start Planning</button> */}
...
>>>>>>> 628fbc4088434ff1b433da641e4cb26afbd87acf
                ...
                <div className='w-full max-w-[1400px] ml-48 mt-64 '>
                    ...
                    <div className='z-10 mt-9  '>
                        {/* <button className="relative overflow-hidden bg-[#000000] text-[#FC6736] p-4 rounded-xl font-bold text-2xl hover:bg-[#FC6736] hover:text-[#0C2D57] transition duration-300 ease-in-out">
                            <span className="absolute top-0 left-0 w-full h-full bg-[#FC6736] mix-blend-multiply transition-transform duration-300 ease-in-out transform scale-0 origin-top-left"></span>
                            Get Started
                        </button> */}
                        {/* <button className="relative overflow-hidden bg-[#000000] text-[#FFB0B0] p-4 rounded-xl font-bold text-2xl hover:bg-[#FC6736] hover:text-[#0C2D57] transition duration-300 ease-in-out">
                        ...
                        <div href="#_" class="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-[#000000] transition-all duration-150 ease-in-out rounded-xl hover:pl-10 hover:pr-6 bg-gray-50 group cursor-pointer p-5">
                            ...
                            <span class="relative w-full text-left transition-colors duration-200 ease-in-out group-hover:text-white p-2">Button Text</span>
                        </div>
                    </div>
                </div>
                <img
